...
@WebServlet("/TransactionDebited")
public class TransactionDebited extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			list=obj.transactionDebited(senderNo);
			request.setAttribute("list",list);
			RequestDispatcher dispatcher = request.getRequestDispatcher("transactionDebited.jsp");
