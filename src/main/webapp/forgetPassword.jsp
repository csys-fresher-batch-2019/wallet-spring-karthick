...
<br>
<form action="ForgetMobVerification">
<br>
<br>
<div class="c"><class="thicker"><pre>Mobile No :<input type="number" name="mobilenumber"  pattern="[0-9]{10}" required placeholder="Enter mobile number" autofocus><br /></pre></div>
<br>
