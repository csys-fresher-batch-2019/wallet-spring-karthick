...
<form action="BussVerifyOTPServlet">
<%
long mobileNo =(Long)request.getAttribute("mobileNo");
int otp =Integer.parseInt(request.getAttribute("otp").toString());
%>
<div class="c"><class="thicker"><pre>Verification OTP :<input type="number" name="otp" placeholder="Enter OTP" required autofocus><br /></pre></div>
