...
<div class="c"><class="thicker"><pre>    Mobile Number :<input type="number" name="mobilenumber" maxlength="10" placeholder="Enter mobile number" autofocus required> </pre></div><br>
